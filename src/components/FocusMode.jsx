      ...
      {isDimmed && (
        ...
        >
          <div className="bg-red-950/90 border-2 border-red-500 p-6 rounded-2xl text-center space-y-2 max-w-md shadow-2xl pointer-events-auto">
            ...
            <h3 className="text-lg font-bold text-red-200 uppercase tracking-wider">Eye Distance Warning!</h3>
            <p className="text-xs text-red-300 leading-relaxed">
              You are sitting too close to the screen (<strong>{eyeDistanceCm} cm</strong>) for &gt;20s. Screen brightness has dimmed to protect your retina. Please sit back &gt;50cm!
            </p>
          </div>
        </div>
      )}
        ...
        <div className="lg:col-span-7 bg-slate-900/90 rounded-2xl border border-slate-800 p-6 shadow-2xl flex flex-col space-y-6">
          ...
          <div className="bg-slate-950 p-7 rounded-2xl border border-slate-800/80 flex flex-col items-center justify-center space-y-6 relative">
            ...
            <div className="text-center">
              ...
              <div className="text-xs uppercase font-mono tracking-widest text-blue-400 mt-2 font-bold">
                {isTimerRunning ? 'Focus Session In Progress' : 'Ready To Start Focus Session'}
              </div>
            </div>
            ...
            <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-900/90 p-2.5 rounded-xl border border-slate-800 text-xs font-mono">
              ...
              <div className="flex items-center space-x-1.5">
                <span className="text-slate-500 text-[11px] font-semibold">Presets:</span>
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center bg-slate-950 rounded-lg border border-slate-800 overflow-hidden">
                  ...
                  <input
                    ...
                    title="Enter custom minutes (1 - 360)"
                  />
                  <span className="text-[10px] text-slate-500 pr-1.5">min</span>
            ...
            <div className="flex items-center space-x-4 pt-1">
              ...
              <button
                ...
                title="Reset session to default"
              >
          ...
          <div className="bg-slate-950 p-4 rounded-xl border border-slate-800 space-y-3">
            ...
            <div className="w-full h-3 bg-slate-900 rounded-full overflow-hidden p-0.5 border border-slate-800 relative">
              ...
              />
              <div className="absolute top-0 bottom-0 left-[77%] w-0.5 bg-red-500/80" title="Danger threshold > 1.25" />
              <div className="absolute top-0 bottom-0 left-[68%] w-0.5 bg-amber-400/60" title="Warning threshold > 1.10" />
            </div>

            <div className="flex items-center justify-between text-[11px] text-slate-400">
              <span>💡 Danger warning triggers if ratio &gt; 1.25 for 1.5s (Hysteresis clears at &lt; 1.18).</span>
              <span className="font-mono text-emerald-400">
                {cameraEnabled ? (eyeData.detected ? `🎯 Tracking ${eyeData.eye_boxes.length} eyes` : '🔍 Scanning for eyes...') : ''}
              </span>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between px-1">
              <div className="flex items-center space-x-2 text-xs font-mono text-slate-300">
                ...
                <span className={`text-[10px] px-1.5 py-0.2 rounded font-mono ${
                  ...
                  {cameraEnabled ? `${inferenceMode.toUpperCase()} // ${fps} FPS` : 'DISABLED'}
                </span>
              </div>
              ...
              <div className="flex items-center space-x-2">
                {cameraEnabled && (
                  ...
                  >
                    ...
                    <span>{showHUDOverlay ? 'YOLO HUD: ON' : 'YOLO HUD: OFF'}</span>
                  </button>
                )}
                <button
          ...
          <div className="bg-slate-900/90 rounded-2xl border border-slate-800 p-6 shadow-2xl space-y-4">
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="text-xs font-bold text-slate-200 uppercase tracking-wider">Ambient Noise Level (Real Mic)</h3>
                  <p className="text-[10px] text-slate-400">Real-time SPL decibel readings from room microphone</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2">
                <span className={`text-[10px] font-mono px-2 py-0.5 rounded border ${
                  ...
                  {micEnabled ? 'REAL MIC ACTIVE' : 'MIC OFF'}
                </span>
                <button
                  onClick={onOpenPermissionModal}
                  className="text-[10px] font-mono px-2 py-0.5 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 border border-slate-700 transition cursor-pointer"
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between text-[11px] font-mono text-slate-400">
                <span>Real Mic Audio Frequency Spectrum:</span>
                <span>{micEnabled ? 'Real-Time WebAudio FFT' : 'Paused'}</span>
              </div>
