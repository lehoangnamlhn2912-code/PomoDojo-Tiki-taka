      ...
      <div className="bg-slate-900 border border-slate-700 rounded-2xl max-w-lg w-full p-6 shadow-2xl relative space-y-6">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">Strict student privacy & local biometric security commitment</p>
          </div>
        </div>
        ...
        <div className="space-y-3 text-xs">
          ...
          <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 flex items-start space-x-3">
            ...
            <div>
              <strong className="text-slate-200 block font-semibold mb-0.5">1. No Webcam Recording or Storage:</strong>
              <span className="text-slate-400 leading-relaxed">
                The application uses camera frames strictly in transient RAM to compute relative eye distances and exercise poses. No photos, videos, or facial biometric templates are ever recorded or stored.
              </span>
            </div>
          </div>
          ...
          <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 flex items-start space-x-3">
            ...
            <div>
              <strong className="text-slate-200 block font-semibold mb-0.5">2. 100% On-Device Edge-AI:</strong>
              <span className="text-slate-400 leading-relaxed">
                All computer vision neural networks (MediaPipe Face Mesh, MoveNet, WebAudio FFT) execute directly on your local CPU/GPU within the browser sandbox.
              </span>
            </div>
          </div>
          ...
          <div className="p-3.5 bg-slate-950 rounded-xl border border-slate-800 flex items-start space-x-3">
            ...
            <div>
              ...
              <span className="text-slate-400 leading-relaxed">
                Core posture monitoring and eye-guard utilities work completely offline. No visual feeds or private telemetry are transmitted to any external server.
              </span>
            </div>
          </div>
