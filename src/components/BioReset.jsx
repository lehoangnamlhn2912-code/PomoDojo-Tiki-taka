    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            <div className="flex items-center space-x-2">
              <span className="text-[10px] font-mono uppercase tracking-widest text-blue-400 font-bold">Phase 0</span>
            ...
            <p className="text-xs text-slate-400 mt-1">
              Synchronize heart rhythm and brain waves to balanced Alpha state (432Hz) before entering deep focus.
            </p>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="text-[10px] text-slate-400 font-mono mt-0.5">
                {isRunning ? `${phaseCounter}s` : '30s Breath Loop'}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700/50">
          <div className="text-xs font-bold text-blue-400 uppercase tracking-widest mb-1">1. Inhale (4s)</div>
          <p className="text-xs text-slate-400">Breathe deeply through nose, expanding diaphragm to flood brain with fresh oxygen.</p>
        </div>
        <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700/50">
          <div className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-1">2. Hold (4s)</div>
          <p className="text-xs text-slate-400">Gently suspend air in lungs, maximizing gas exchange into bloodstream.</p>
        </div>
        <div className="bg-slate-800/40 p-4 rounded-xl border border-slate-700/50">
          <div className="text-xs font-bold text-indigo-400 uppercase tracking-widest mb-1">3. Exhale (4s)</div>
          <p className="text-xs text-slate-400">Slowly release through mouth, dropping shoulder and physical tension before work.</p>
        </div>
      </div>
    </div>
  );
